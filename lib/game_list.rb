module UltraGamer
    class Game_deals
        ...
        def self.essential_picks(deal_name)
         ...
         essential_list.sort_by! {|g| [g.name, g.url, g.price, g.console, g.type]}
         essential_list
        end
        ...
        def self.ps_vr(deal_name)
         ...
         psvr_list.sort_by! {|g| [g.name, g.url, g.price, g.console, g.type]}
         psvr_list
        end
        ...
        def self.deal_of_week(deal_name)
           ...
           dow_list.sort_by! {|g| [g.name, g.url, g.price, g.console, g.type]}
           dow_list
        end
        ...
        def self.under_fifteen(deal_name)
           ...
           under_list.sort_by! {|g| [g.name, g.url, g.price, g.console, g.type]}
           under_list
        end
        ...
        def self.all_deals(deal_name)
         ...
         all_list.sort_by! {|g| [g.name, g.url, g.price, g.console, g.type]}
         all_list
        end
